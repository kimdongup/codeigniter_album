...
<?php
	...
	function mobile_more_list2()
	{
		...
		foreach($query->result() as $lt)
		{
			...
			if(is_file('./uploads/'.$file_info[0]."_thumb.".$file_info[1]))
			{
				$thumb_img = 'http://kimdongup.net/sns/uploads/'.$file_info[0]."_thumb.".$file_info[1];
			}
			else
			{
				$thumb_img = 'http://kimdongup.net/sns/uploads/'.$lt->file_name;
			}
