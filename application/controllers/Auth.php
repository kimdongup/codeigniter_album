...
class Auth extends CI_Controller {
			...
			if ( $result )
   			{
				...
				$this->session->set_userdata($newdata);
  				...
  				alert('로그인 되었습니다.', '/sns/index.php/controlls/lists/page/1');
  				exit;
   			}
   			else
   			{
   				//실패시
  				alert('아이디나 비밀번호를 확인해 주세요.', '/sns/index.php/controlls/lists/page/1');
  				exit;
   			}
	...
	public function logout()
	{
		...
		echo '<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />';
		alert('로그아웃 되었습니다.', '/sns/index.php/controlls/lists/page/1');
  		exit;
	}
