...
//print_r($views);
?>
	<!--<script type="text/javascript" src="/sns/include/js/httpRequest.js"></script>-->
	<script type="text/javascript">
	$(function(){
		$("#comment_add").click(function(){
			$.ajax({
				url: "/sns/index.php/ajax_board/ajax_comment_add",
				type: "POST",
				data:{
		...
		$(".comment_delete").click(function(){
			$.ajax({
				url: "/sns/index.php/ajax_board/ajax_comment_delete",
				type: "POST",
				data:{
					"csrf_test_name":getCookie('csrf_cookie_name'),
					"id":$(this).attr("vals")
	...
	<article id="board_area">
		...
		<table cellspacing="0" cellpadding="0" class="table table-striped">
			...
			<tfoot>
				<tr>
					<th colspan="4"><a href="/sns/index.php/controlls/lists/page/<?php echo $this->uri->segment(5);?>" class="btn btn-primary">목록</a> <a href="/sns/index.php/controlls/modify_photo/<?php echo $this->uri->segment(3);?>" class="btn btn-warning">수정</a> <a href="/sns/index.php/controlls/delete/<?php echo $this->uri->segment(3);?>/page/<?php echo $this->uri->segment(5);?>" class="btn btn-danger">삭제</a> <a href="/sns/index.php/controlls/upload_photo/page/<?php echo $this->uri->segment(5);?>" class="btn btn-success">쓰기</a></th>
				</tr>
			</tfoot>
		</table>
